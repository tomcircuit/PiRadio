...
#define Q_LED_TRIS               TRISC0
#define Q_LED_LAT                LATC0
#define Q_LED_PORT               PORTCbits.RC0
#define Q_LED_SetHigh()    do { LATC0 = 1; } while(0)
#define Q_LED_SetLow()   do { LATC0 = 0; } while(0)
#define Q_LED_Toggle()   do { LATC0 = ~LATC0; } while(0)
#define Q_LED_GetValue()         PORTCbits.RC0
#define Q_LED_SetDigitalInput()    do { TRISC0 = 1; } while(0)
#define Q_LED_SetDigitalOutput()   do { TRISC0 = 0; } while(0)

// get/set Q_PIXEL aliases
#define Q_PIXEL_TRIS               TRISC1
#define Q_PIXEL_LAT                LATC1
#define Q_PIXEL_PORT               PORTCbits.RC1
#define Q_PIXEL_SetHigh()    do { LATC1 = 1; } while(0)
#define Q_PIXEL_SetLow()   do { LATC1 = 0; } while(0)
#define Q_PIXEL_Toggle()   do { LATC1 = ~LATC1; } while(0)
#define Q_PIXEL_GetValue()         PORTCbits.RC1
#define Q_PIXEL_SetDigitalInput()    do { TRISC1 = 1; } while(0)
#define Q_PIXEL_SetDigitalOutput()   do { TRISC1 = 0; } while(0)

// get/set Q_BEEP aliases
#define Q_BEEP_TRIS               TRISC2
#define Q_BEEP_LAT                LATC2
#define Q_BEEP_PORT               PORTCbits.RC2
#define Q_BEEP_ANS                ANSC2
#define Q_BEEP_SetHigh()    do { LATC2 = 1; } while(0)
#define Q_BEEP_SetLow()   do { LATC2 = 0; } while(0)
#define Q_BEEP_Toggle()   do { LATC2 = ~LATC2; } while(0)
#define Q_BEEP_GetValue()         PORTCbits.RC2
#define Q_BEEP_SetDigitalInput()    do { TRISC2 = 1; } while(0)
#define Q_BEEP_SetDigitalOutput()   do { TRISC2 = 0; } while(0)

#define Q_BEEP_SetAnalogMode()   do { ANSC2 = 1; } while(0)
#define Q_BEEP_SetDigitalMode()   do { ANSC2 = 0; } while(0)
...
#define Q_PI27_TRIS               TRISC4
#define Q_PI27_LAT                LATC4
#define Q_PI27_PORT               PORTCbits.RC4
#define Q_PI27_ANS                ANSC4
#define Q_PI27_SetHigh()    do { LATC4 = 1; } while(0)
#define Q_PI27_SetLow()   do { LATC4 = 0; } while(0)
#define Q_PI27_Toggle()   do { LATC4 = ~LATC4; } while(0)
#define Q_PI27_GetValue()         PORTCbits.RC4
#define Q_PI27_SetDigitalInput()    do { TRISC4 = 1; } while(0)
#define Q_PI27_SetDigitalOutput()   do { TRISC4 = 0; } while(0)

#define Q_PI27_SetAnalogMode()   do { ANSC4 = 1; } while(0)
#define Q_PI27_SetDigitalMode()   do { ANSC4 = 0; } while(0)
// get/set Q_AUX aliases
#define Q_AUX_TRIS               TRISC5
#define Q_AUX_LAT                LATC5
#define Q_AUX_PORT               PORTCbits.RC5
#define Q_AUX_ANS                ANSC5
#define Q_AUX_SetHigh()    do { LATC5 = 1; } while(0)
#define Q_AUX_SetLow()   do { LATC5 = 0; } while(0)
#define Q_AUX_Toggle()   do { LATC5 = ~LATC5; } while(0)
#define Q_AUX_GetValue()         PORTCbits.RC5
#define Q_AUX_SetDigitalInput()    do { TRISC5 = 1; } while(0)
#define Q_AUX_SetDigitalOutput()   do { TRISC5 = 0; } while(0)

#define Q_AUX_SetAnalogMode()   do { ANSC5 = 1; } while(0)
#define Q_AUX_SetDigitalMode()   do { ANSC5 = 0; } while(0)
// get/set TX1 aliases
...
#define SCL2_LAT                LATD0
#define SCL2_PORT               PORTDbits.RD0
#define SCL2_ANS                ANSD0
#define SCL2_SetHigh()    do { LATD0 = 1; } while(0)
#define SCL2_SetLow()   do { LATD0 = 0; } while(0)
#define SCL2_Toggle()   do { LATD0 = ~LATD0; } while(0)
#define SCL2_GetValue()         PORTDbits.RD0
#define SCL2_SetDigitalInput()    do { TRISD0 = 1; } while(0)
#define SCL2_SetDigitalOutput()   do { TRISD0 = 0; } while(0)

#define SCL2_SetAnalogMode()   do { ANSD0 = 1; } while(0)
#define SCL2_SetDigitalMode()   do { ANSD0 = 0; } while(0)
// get/set SDA2 aliases
#define SDA2_TRIS               TRISD1
#define SDA2_LAT                LATD1
#define SDA2_PORT               PORTDbits.RD1
#define SDA2_ANS                ANSD1
#define SDA2_SetHigh()    do { LATD1 = 1; } while(0)
#define SDA2_SetLow()   do { LATD1 = 0; } while(0)
#define SDA2_Toggle()   do { LATD1 = ~LATD1; } while(0)
#define SDA2_GetValue()         PORTDbits.RD1
#define SDA2_SetDigitalInput()    do { TRISD1 = 1; } while(0)
#define SDA2_SetDigitalOutput()   do { TRISD1 = 0; } while(0)

#define SDA2_SetAnalogMode()   do { ANSD1 = 1; } while(0)
#define SDA2_SetDigitalMode()   do { ANSD1 = 0; } while(0)
// get/set Q_SW5V aliases
#define Q_SW5V_TRIS               TRISD2
#define Q_SW5V_LAT                LATD2
#define Q_SW5V_PORT               PORTDbits.RD2
#define Q_SW5V_ANS                ANSD2
#define Q_SW5V_SetHigh()    do { LATD2 = 1; } while(0)
#define Q_SW5V_SetLow()   do { LATD2 = 0; } while(0)
#define Q_SW5V_Toggle()   do { LATD2 = ~LATD2; } while(0)
#define Q_SW5V_GetValue()         PORTDbits.RD2
#define Q_SW5V_SetDigitalInput()    do { TRISD2 = 1; } while(0)
#define Q_SW5V_SetDigitalOutput()   do { TRISD2 = 0; } while(0)

#define Q_SW5V_SetAnalogMode()   do { ANSD2 = 1; } while(0)
#define Q_SW5V_SetDigitalMode()   do { ANSD2 = 0; } while(0)
